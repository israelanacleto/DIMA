...
namespace Dima.Api.Migrations
{
    ...
    [Migration("20260416181952_AddCategoryIsActive")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dima.Api.Models.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Dima.Core.Models.Dashboard.ExpensesByCategory", b =>
                {
            ...
            modelBuilder.Entity("Dima.Core.Models.Dashboard.IncomesAndExpenses", b =>
                {
                    b.Property<decimal>("Expenses")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Dima.Core.Models.Dashboard.IncomesByCategory", b =>
                {
                    b.Property<string>("Category")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dima.Core.Models.Order", b =>
                {
                    ...
                    b.HasIndex(new[] { "ExternalReference" }, "IX_Order_ExternalReference");

                    b.HasIndex(new[] { "Gateway" }, "IX_Order_Gateway");

                    b.HasIndex(new[] { "Number" }, "IX_Order_Number")
                        .IsUnique();
            ...
            modelBuilder.Entity("Dima.Core.Models.Voucher", b =>
                {
                    ...
                    b.HasIndex(new[] { "IsActive" }, "IX_Voucher_IsActive");

                    b.HasIndex(new[] { "Number" }, "IX_Voucher_Number")
                        .IsUnique();

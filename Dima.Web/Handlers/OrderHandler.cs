...
public class OrderHandler(IHttpClientFactory httpClientFactory) : IOrderHandler
{
    ...
    public async Task<Response<Order?>> CancelAsync(CancelOrderRequest request)
    {
        ...
        return await result.Content.ReadFromJsonAsync<Response<Order?>>()
               ?? new Response<Order?>(null, (int)result.StatusCode, "Falha ao cancelar pedido");
    }
    ...
    public async Task<Response<Order?>> CreateAsync(CreateOrderRequest request)
    {
        ...
        return await result.Content.ReadFromJsonAsync<Response<Order?>>()
               ?? new Response<Order?>(null, (int)result.StatusCode, "Falha ao criar a pedido");
    }
    ...
    public async Task<Response<Order?>> PayAsync(PayOrderRequest request)
    {
        ...
        return await result.Content.ReadFromJsonAsync<Response<Order?>>()
               ?? new Response<Order?>(null, (int)result.StatusCode, "Falha ao pagar pedido");
    }
